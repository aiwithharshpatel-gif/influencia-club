...
const Footer = () => {
  ...
  return (
    <footer className="bg-bg-card border-t border-border transition-colors duration-300">
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-12">
            ...
            <div className="flex space-x-4 pt-2">
              {socialLinks.map((social) => (
                <a
                  ...
                  className="w-9 h-9 rounded-full bg-bg border border-border flex items-center justify-center text-muted hover:text-gold hover:border-gold/40 hover:bg-gold/5 transition-all duration-300"
            ...
            <ul className="space-y-3">
              {platformLinks.map((link) => (
                <li key={link.path}>
                  <Link
                    to={link.path}
                    className="text-muted text-sm hover:text-gold hover:pl-1 transition-all duration-300"
                  >
                    {link.label}
                  </Link>
                </li>
          ...
          <div>
            ...
            <ul className="space-y-3 text-sm">
              <li className="text-muted hover:text-gold transition-colors">hello@influenziaclub.com</li>
        ...
        <div className="mt-16 pt-8 border-t border-border">
          <div className="flex flex-col md:flex-row justify-between items-center space-y-4 md:space-y-0">
            ...
            <p className="text-muted text-xs tracking-wide flex items-center">
              Powered by{' '}
              <span className="text-gold ml-1 font-semibold hover:text-gold/80 transition-colors duration-300">ZCAD Nexoraa Pvt. Ltd.</span>
